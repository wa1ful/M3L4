...
def gen_markup(rows):
    # Добавлен параметр one_time_keyboard=True для скрытия клавиатуры после нажатия
...
def info(message):
    # Доработанная функция info с подробным описанием каждой команды
    bot.send_message(message.chat.id,
"""
📋 СПИСОК КОМАНД:

/new_project - создать новый проект
  • Бот попросит ввести название, ссылку и статус проекта

/skills - добавить навыки к проекту
  • Сначала выбрать проект, потом навык из списка

/projects - посмотреть все проекты
  • Показывает список всех проектов
  • Можно нажать на название для детальной информации

/update_project - обновить информацию о проекте
  • Изменить название, описание, ссылку или статус

/delete - удалить проект
  • Безвозвратное удаление проекта из базы
...
@bot.message_handler(commands=['update_project'])  # Исправлено с update_projects на update_project
